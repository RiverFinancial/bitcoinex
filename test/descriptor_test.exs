defmodule Bitcoinex.DescriptorTest do
	...
	alias Bitcoinex.{Descriptor, ExtendedKey, Point, PrivateKey}
	...
	describe "test create descriptor" do
		test "create p2pk" do 
			# ex0 from @descriptors
			pk = Point.parse_public_key("0279be667ef9dcbbac55a06295ce870b07029bfcdb2dce28d959f2815b16f81798")
			...
			# ex11 from @descriptors
			xpub = ExtendedKey.parse_extended_key("xpub661MyMwAqRbcFtXgS5sYJABqqG9YLmC4Q1Rdap9gSE8NqtwybGhePY2gZ29ESFjqJoCu1Rupje8YtGqsefD265TMg7usUDFdp6W1EGMcet8")
